...
pkgver=20120718
pkgrel=1
pkgdesc="RSS Feed News Ticker. Plasmoid (plasma widget/applet) NetNewsTicker for single line rss news 
reader"
arch=('i686' 'x86_64')
url='http://netnewsticker.org/'
license=('GPL')
depends=('boost' 'kdepim-runtime' 'kdebase-runtime')
...
source=()
md5sums=()
_gitroot="git://github.com/Grarap/Newsticker.git"
_gitname="Newsticker"
